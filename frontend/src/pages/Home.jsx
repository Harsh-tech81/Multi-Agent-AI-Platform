...
function Home() {
  ...
  return (
    <div className="flex  h-screen bg-[#111215] text-white overflow-hidden">
...
<Artifact/>
...

    {
      !userData && <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur">
        <div className="flex w-[340px] bg-[#151618] border border-white/[0.10] rounded-2xl p-7 flex-col gap-5">
